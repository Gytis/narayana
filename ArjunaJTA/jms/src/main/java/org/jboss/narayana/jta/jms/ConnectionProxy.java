...
public class ConnectionProxy implements Connection {
    ...
    public void close() throws JMSException {
        if (transactionHelper.isTransactionAvailable()) {
            Synchronization synchronization =
                    new ConnectionClosingSynchronization(xaConnection);
            transactionHelper.registerSynchronization(synchronization);

            if (LOGGER.isLoggable(Level.FINE)) {
                LOGGER.fine("Registered synchronization to close the connection: "
                        + synchronization);
            }
        } else {
            xaConnection.close();
    ...
    public ConnectionConsumer createConnectionConsumer(Destination destination,
        ...
        return xaConnection.createConnectionConsumer(destination,
    ...
    public ConnectionConsumer createDurableConnectionConsumer(Topic topic,
        ...
        return xaConnection.createDurableConnectionConsumer(topic,
