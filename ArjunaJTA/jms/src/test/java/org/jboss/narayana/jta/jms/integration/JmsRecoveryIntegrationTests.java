...
public class JmsRecoveryIntegrationTests extends AbstractIntegrationTests {
    ...
    @BMRule(
            ...
            helper = "org.jboss.narayana.jta.jms.helpers.BytemanHelper",
    ...
    public void shouldCrashBeforeCommitAndRecover() throws Exception {
        ...
        when(xaResourceMock.recover(anyInt()))
            .then(i -> mockXids.toArray(new Xid[mockXids.size()]));
        when(xaResourceRecoveryHelperMock.getXAResources())
                .thenReturn(new XAResource[] { xaResourceMock });
