...
public class ConnectionFactoryProxyTests {
    ...
    public void shouldGetConnection() throws JMSException {
        ...
        ConnectionFactory factory = new ConnectionFactoryProxy(
                xaConnectionFactoryMock, transactionHelperMock);
    ...
    public void shouldGetConnectionWithCredentials() throws JMSException {
        ...
        when(xaConnectionFactoryMock.createXAConnection(username, password))
                .thenReturn(xaConnectionMock);
        ...
        assertThat(connection, instanceOf(ConnectionProxy.class));
        verify(xaConnectionFactoryMock, times(1))
                .createXAConnection(username, password);
    }
