...
public class JmsHelper {
    ...
    private JMSConfiguration getJmsConfiguration() {
        ...
        jmsConfiguration.getConnectionFactoryConfigurations()
                .add(getConnectionFactoryConfiguration());
    ...
    private ConnectionFactoryConfiguration getConnectionFactoryConfiguration() {
        ...
        return new ConnectionFactoryConfigurationImpl().setName(FACTORY_NAME)
                .setConnectorNames(connectorNames).setBindings(FACTORY_NAME);
    }

    private JMSQueueConfiguration getQueueConfiguration() {
        return new JMSQueueConfigurationImpl().setName(QUEUE_NAME)
                .setDurable(false).setBindings(QUEUE_NAME);
    }
